...
const handle = (
  ...
  { url, operationId, preHandlers, handlers, schema, includeUserObject, isPublic, tags, summary, description, deprecated, warnOnRequestValidationError, jsonOptions }
) => {
  ...
  routeDefinitions[method][url] = { url, operationId, schema, isPublic, includeUserObject, tags, summary, description, deprecated }
