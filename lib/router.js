...
const handle = (
  ...
  method,
  routeDefinitions,
  { validateResponses, logRequests, logResponses, logMemoryUsage, correlationIdExtractor, logger, appEnv },
  ...
  const shouldLogMemoryUsage = (logMemoryUsage === undefined && appEnv === 'development') || logMemoryUsage

  if (shouldLogRequests) {
    _handlers.push(networkLogger({ correlationIdExtractor, logger, shouldLogResponses, shouldLogMemoryUsage }))
  }
