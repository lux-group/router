...
const handle = (
  ...
  method,
  routeDefinitions,
  { validateResponses, logRequests, correlationIdExtractor, logger, appEnv },
  ...
  if (logRequests || appEnv === "development") {
    _handlers.push(networkLogger({ correlationIdExtractor, logger }))
  }
